...
const Cart = () => {
  return (
    <View style={{width:'100%',height:'100%'}}>
      ...
      <View style={{width:'100%',height:'8%',backgroundColor:'white',flexDirection: 'row',alignItems:'space-between',alignItems: 'center',}}>
      ...
      <View style={{width:'100%',height:'70%',}}>
        ...
        <FlatList
				...
				renderItem={({ item }) => {
				return (
					<View style={{ width: '96%', height: 100, borderRadius: 15,marginLeft: 10,flexDirection: 'row',backgroundColor:'#eeeee4',marginTop: 6}}>
      ...
      <View style={{width:'100%',height:'10%',flexDirection: 'row',alignItems:'space-between'}}>
         <View style={{width:'40%',height:'50%',alignItems: 'center',justifyContent: 'center'}}>
            <Text style={{fontSize:20,fontWeight:'bold', color: '#ea8631'}}>Total Price</Text>
          <Text style={{fontSize:20,fontWeight:'bold'}}>$120</Text>
         </View>
         <View style={{width:'60%',height:'100%',backgroundColor:'#ea8631',alignItems: 'center',justifyContent: 'center',borderRadius: 20}}>
