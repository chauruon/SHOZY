...
const data = [
	{
		id: 1,
    Image:'https://www.pexels.com/vi-vn/anh/nh-c-a-giay-th-thao-tren-n-n-tr-ng-2529148/',
		title: 'Running Shoes',
  ...
  {
		id: 2,
    Image:'https://salt.tikicdn.com/cache/400x400/ts/product/67/ed/dc/c75f6470253ce8d706ae336ff549a6ca.jpg.webp',
		title: '...Shoes',
      ...
      <View style={{width:'100%',height:'70%',}}>
        ...
        <FlatList
				...
				<View style={{width: '25%', height:'100%',borderRadius: 10,}}>
					<Image style={{width:'100%', height:'100%',borderRadius: 10}}>{item.Image}</Image>
				</View>
