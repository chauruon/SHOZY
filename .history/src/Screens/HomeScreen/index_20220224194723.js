  ...
  return (
    <View style={{ width: '100%', height: '100%', backgroundColor: 'red' }}>
      <View style={styles.container}>
        ...
        <View style={{width:'60%', height:'35%',marginTop:15,marginLeft:10,flexDirection: 'row',backgroundColor:'black'}}> 
        <Switch 
        ...
        value={isEnabled}
      /> 
      <Text style={{marginTop:15,fontSize:20, fontWeight: 'bold',backgroundColor: 'white'}}>Sneacker</Text>
      </View>
      </View>
