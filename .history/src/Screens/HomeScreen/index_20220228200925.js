    ...
    <>
      <View style={{ width: '100%', height: '100%' }}>
        ...
        <View style={{ width: '100%', height: '70%' }}>
          ...
          <View style={{ width: '50%', height: '60%', backgroundColor: 'red', borderRadius: 30 , alignItems: 'center'}}>
          ...
          <FlatList
              ...
              renderItem={({ item }) => {
                return (
                  <View style={{ width: '80%', height: '80%', backgroundColor: 'yellow', borderRadius: 20,}}>                   
