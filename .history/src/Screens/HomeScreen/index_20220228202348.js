    ...
    <>
      <View style={{ width: '100%', height: '100%' }}>
        ...
        <View style={{ width: '100%', height: '70%' }}>
          ...
          <View style={{ width: '50%', height: '60%', backgroundColor: 'gray', borderRadius: 20 ,}}>
        ...
        <View style={{ width: '100%', height: '20%', backgroundColor: 'gray', borderRadius: 20 ,flexDirection: 'row'}}>
          <Image style={{width: "30%", height: "90%", borderRadius: 20 }}
            source={{uri:'https://cf.shopee.vn/file/311918633451d5d5e9da52ecb7aef296'}}/>
          <FlatList
              data={data}
              keyExtractor={item => item.id}
              renderItem={({ item }) => {
                return (
                  <View style={{ width: '100%', height: '96%', backgroundColor: 'white', borderRadius: 20,marginLeft:4,marginTop:2}}>                   
                    <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'black', marginLeft: 20 }}>1</Text>
                    <Text style={{ fontSize: 20, fontWeight: 'itachi', color: 'black', marginLeft: 20 }}>2</Text>
                    <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'black', marginLeft: 20 }}>3</Text>
                  </View>
                );
              }}
            />
