...
import { Image, Text, TextInput, View, Switch,FlatList, ScollView } from 'react-native';
    ...
    <>
      ...
      <View style={{ width: '100%', height: '100%' }}>
        ...
        <View style={{ width: '100%', height: '70%' }}>
          ...
          <View style={{ width: '50%', height: '60%', backgroundColor: 'gray', borderRadius: 20 ,marginTop: 15}}>
        ...
        <View style={{ width: '90%', height: '20%', backgroundColor: 'gray', borderRadius: 20 ,flexDirection: 'row',marginTop: 15,marginLeft: 15}}>
