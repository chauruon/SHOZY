      ...
      <View style={{ width: '100%', height: '100%' }}>
        ...
        <View style={{ width: '100%', height: '70%' }}>
          ...
          <FlatList
              ...
              renderItem={({ item }) => {
                return (
                  <View style={{ width: '50%', height: '100%', backgroundColor: 'gray', borderRadius: 20 ,marginTop: 15,marginLeft:15}}>
                  <View style={{ width: '16%', height: '16%', backgroundColor: 'white', borderRadius: 20,marginLeft:4,marginTop:2}}>                   
