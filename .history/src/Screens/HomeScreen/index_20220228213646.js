...
const data = [
  {
    id: 1,
    image: 'https://cf.shopee.vn/file/311918633451d5d5e9da52ecb7aef296',
    title: 'air force',
    name: "nike",
    price: '$115',
  },
  {
    id: 2,
    image: url('https://cf.shopee.vn/file/311918633451d5d5e9da52ecb7aef296'),
    title: 'air force',
    name: "nike",
    price: '$115',
  },
      ...
      <View style={{ width: '100%', height: '100%' }}>
        ...
        <View style={{ width: '100%', }}> 
          <FlatList
              ...
              renderItem={({ item }) => {
                return (
                  <View style={{ width: '50%', height: '100%', backgroundColor: 'gray',}}>
