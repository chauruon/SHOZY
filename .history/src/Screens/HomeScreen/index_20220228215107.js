    ...
    <>
      ...
      <View style={{ width: '100%', height: '100%' }}>
        <View style={styles.container}>
          ...
          <View style={{ width: '45%', marginTop: 15, flexDirection: 'row', backgroundColor: 'black', borderRadius: 200, alignItems: 'center' }}>
            <Switch
          ...
          <FlatList
              ...
              renderItem={({ item }) => {
                return (
                  ...
                  <View style={{ width: '100%', height: '90%', backgroundColor: 'white', borderRadius: 20,}}>                   
