          ...
          <FlatList
              ...
              renderItem={({ item }) => {
                return (
                  ...
                  <View style={{ width: 150, height: '50%', backgroundColor: 'white', borderRadius: 20,backgroundColor:'red',marginLeft: 20 }}>                   
                    <View style={{ width: 150, height: '50%', backgroundColor: 'white', borderRadius: 20,backgroundColor:'yellow',marginLeft: 20 }}>                   
