  ...
  return (
    <>
      ...
      <View style={{ width: '100%', height: '100%' }}>
        ...
        />
         <View style={{ width: 40, height: '50%', borderRadius: 10, backgroundColor: 'red', marginLeft: 20 }}>
               
                <View style={{ width: '20%', height: 70, borderRadius: 10, backgroundColor: 'yellow', marginTop: '-50%', alignSelf: 'center' }}>
