  ...
  return (
    <>
      ...
      <View style={{ width: '100%', height: '100%' }}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            return (
              ...
              <View style={{ width: 150, height: '80%', borderRadius: 10, backgroundColor: 'red', marginLeft: 20 }}>
        ...
        />
              <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'black', marginLeft: 20 ,marginTop: '-50%'}}>most popural</Text>
