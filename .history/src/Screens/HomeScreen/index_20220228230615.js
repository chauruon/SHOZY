  ...
  return (
    <>
      ...
      <View style={{ width: '100%', height: '100%' }}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            return (
              ...
              <View style={{ width: 150, height: '80%', borderRadius: 10, backgroundColor: 'red', marginLeft: 20 ,marginTop: 15}}>
        ...
        />
              <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'black', marginLeft: 20,marginBottom:40}}>last viewed</Text>

         <View style={{ width: '90%', height: '15%', borderRadius: 10, backgroundColor: 'red', marginLeft: 20,flexDirection: 'row'}}>   
                  <View style={{width: '20%', height:'100%',backgroundColor:'blue'}}>
                  <Image style={{width:'100%', height:'100%',}} source={hinhnen} />
                  </View>
                  <View style={{width: '80%', height:'100%',backgroundColor:'green', justifyContent:'center'}}>
