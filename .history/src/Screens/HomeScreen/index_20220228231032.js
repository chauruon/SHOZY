    ...
    <>
      ...
      <View style={{ width: '100%', height: '100%' }}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => {
            return (
              ...
              <View style={{ width: 150, height: '90%', borderRadius: 10, backgroundColor: 'red', marginLeft: 20 ,marginTop: 15}}>
        ...
        />
         ...
         <View style={{ width: '90%', height: '15%', borderRadius: 10, backgroundColor: 'red', marginLeft: 20,flexDirection: 'row',marginTop: 15}}>   
                  <View style={{width: '20%', height:'100%',backgroundColor:'blue',borderRadius: 10}}>
                  <Image style={{width:'100%', height:'100%',}} source={hinhnen} />
                  </View>
                  <View style={{width: '80%', height:'100%',backgroundColor:'green', justifyContent:'center',borderRadius: 10}}>
