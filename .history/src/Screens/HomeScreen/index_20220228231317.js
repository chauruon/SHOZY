    ...
    <>
      ...
      <View style={{ width: '100%', height: '100%' }}>
        ...
        />
         ...
         <View style={{ width: '90%', height: '15%', borderRadius: 15, backgroundColor: 'red', marginLeft: 20,flexDirection: 'row',marginTop: 15}}>   
                  <View style={{width: '25%', height:'100%',backgroundColor:'blue',borderRadius: 10}}>
                  <Image style={{width:'100%', height:'100%',borderRadius: 10}} source={hinhnen} />
                  </View>
                  <View style={{width: '70%', height:'100%',backgroundColor:'green', justifyContent:'center',borderRadius: 10,marginLeft: 10}}>
