				...
				renderItem={({ item }) => {
					return (
						<View style={{ width: 150, height: '90%', borderRadius: 10, marginLeft: 20, marginTop: 15 }}>
							...
							<View style={{ width: '90%', height: 60, borderRadius: 10, backgroundColor: 'white', marginTop: '-40%', alignSelf: 'center' }}>
								<Text style={{ fontSize: 18, fontWeight:'bold',color:'black',marginLeft:10,marginTop:8}}>{item.title}</Text>
								<View style={{ flexDirection: 'row', alignItems: 'space-between' }}>
